...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About Goldencoin"), this);
...
void BitcoinGUI::createMenuBar()
{
    ...
    file->setStyleSheet("background-image: url(:/images/bkg-n);");
    ...
    settings->setStyleSheet("background-image: url(:/images/bkg-n);");
    ...
    help->setStyleSheet("background-image: url(:/images/bkg-n);");
    help->addSeparator();
...
static QWidget* makeToolBarSpacer()
{
    ...
    //spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background: rgb(36,34,30); }" : "QWidget { background: none; }");
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QWidget { background-repeat: no-repeat; background-image: url(:/images/bkg_free); border-color: red; color: rgb(0, 0, 0);}");
...
//header->setStyleSheet("QWidget { background-color: rgb(30,28,24); background-repeat: no-repeat; background-image: url(:/images/header); background-position: top center; }");
...
//    toolbar->setStyleSheet("background-image: url(:/images/bkg-n);");
...
//    trayIconMenu->>setStyleSheet("QWidget { background-repeat: no-repeat; background-image: url(:/images/bkg-n); border-color: red; }");
...
{
    QString strTitle = tr("Goldencoin") + " - ";
