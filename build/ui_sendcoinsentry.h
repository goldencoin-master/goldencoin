...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg-n);"));
        ...
        payAmount->setStyleSheet(QString::fromUtf8("background-image: url(:/images/gr);"));
...
"background-color: rgb(154, 134, 106);"));
        ...
        pasteButton->setStyleSheet(QString::fromUtf8("background-color: rgb(154, 134, 106);\n"
