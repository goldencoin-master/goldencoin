...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg-n);"));
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 GLDN"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 GLDN"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 GLDN"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 GLDN"));
        ...
        pushButtonSelectAll->setStyleSheet(QString::fromUtf8("background-color: rgb(154, 134, 106);background-image: url(:/images/bgbfree);"));
        ...
        __qtreewidgetitem->setBackground(6, QColor(38, 58, 131));
        __qtreewidgetitem->setForeground(6, brush5);
        __qtreewidgetitem->setBackground(5, QColor(38, 58, 131));
        __qtreewidgetitem->setForeground(5, brush4);
        __qtreewidgetitem->setBackground(4, QColor(38, 58, 131));
        __qtreewidgetitem->setForeground(4, brush3);
        __qtreewidgetitem->setBackground(3, QColor(38, 58, 131));
        __qtreewidgetitem->setForeground(3, brush2);
        __qtreewidgetitem->setBackground(2, QColor(38, 58, 131));
        __qtreewidgetitem->setForeground(2, brush1);
